GenNorwayMunicipMerging <- function(){
  ...
  masterData <- data.table(readxl::read_excel(file.path("code_msis_project","structural_data", "norwayLocations.xlsx")))
  ...
  return(skeletonFinal[,c("municip","year","municipEnd")])
}
